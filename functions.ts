...
function mine (num1: number , name :string) : number{
...
let mines = function(num1 :number , num2 : number) : number{
...
let val = (num1 :number , num2 :number , num3? :number) :number =>{
...
let nums = (num1 : number , num2 :number , num3 = 20): number =>{
...
function add(num1 :number , num2 :number , ...num3 : number[]): number{
    ...
    for(let i=0; i<num3.length; i++) sum+=num3[i];
...
console.log(getItems<string>(["sam" , "mine"]));
